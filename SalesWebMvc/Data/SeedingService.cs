...
{
    //Quando SeedingService for criado vai receber instancia do context
    public class SeedingService
    {
        ...
        public void Seed() {
            //ver se existe algum registro(Any) nessa tabela
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any())
            {
                return;//BD já foi poupulado(seed)
            }
            //1º obj tipo Department
            ...
            //outra forma fazer
            //Department d5 = new Department { Id = 5, Name = "Teste" };
            ...
            //Adicionar no BD vários de uma vez
            ...
            //Efetivar as alterações(Salva e confirma alterações do BD)
